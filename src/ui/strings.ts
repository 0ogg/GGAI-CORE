...
const STRINGS = {
  ko: {
    ...
    log_modal_title: "생성 로그",
    log_modal_empty: "기록된 생성 내역이 없습니다.",
    log_filter_label: "라벨:",
    log_filter_outcome: "결과:",
    log_filter_all: "전체",
    log_filter_no_label: "(라벨 없음)",
    log_outcome_success: "성공",
    log_outcome_error: "에러",
    log_outcome_cancelled: "취소",
    log_no_label: "(라벨 없음)",
    btn_copy: "복사",
    copied: "복사됨!",
    copy_failed: "복사 실패",
  ...
  en: {
    ...
    log_modal_title: "Generation log",
    log_modal_empty: "No generations recorded.",
    log_filter_label: "Label:",
    log_filter_outcome: "Result:",
    log_filter_all: "All",
    log_filter_no_label: "(no label)",
    log_outcome_success: "Success",
    log_outcome_error: "Error",
    log_outcome_cancelled: "Cancelled",
    log_no_label: "(no label)",
    btn_copy: "Copy",
    copied: "Copied!",
